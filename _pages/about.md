...
- <p style="display: flex; justify-content: space-between; align-items: center; margin: 0 0 0.5em;">
  ...
  <span style="flex: 1 0 auto; text-align: left;">
    <i><a href="https://github.com/YuanGongND/llm_speech_emotion_challenge?tab=readme-ov-file">IEEE SLT 2024 Challenge: LLM-Based Post ASR Speech Emotion Challenge (Task 3 of the GenSEC-LLM Challenge)</a></i>
  </span>
